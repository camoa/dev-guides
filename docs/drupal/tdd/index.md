...
| Write a kernel test | [Kernel Tests with KernelTestBase](kernel-tests.md) | Testing services, entities, database operations, and other Drupal integrations without a full site install. Sweet spot for most Drupal testing. From 11.4 it can request a page with drupalGet(), but not submit a form or log in. |
