...
tldr: "Use this when you need to understand how Canvas handles design tokens, CSS custom properties, and theming — both for the Canvas editor UI and for component styling in SDC and Code Components."
drupal_version: "11.x"
---
