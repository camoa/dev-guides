...
| Optimize images with WebP and AVIF | [WebP & AVIF Optimization](webp-avif-optimization.md) | Use this when you need to optimize image delivery with modern formats (WebP, AVIF) while maintaining fallback for older browsers. AVIF is the Drupal 11 core default but is encoding-heavy; prefer WebP-only on shared/modest hosting. |
