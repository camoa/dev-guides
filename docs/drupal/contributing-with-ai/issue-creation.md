...
6. **Verify steps to reproduce** — Even if AI drafted them, YOU must verify they actually reproduce the issue. Do not submit unverified reproduction steps.
...
- [Disclosure Checkboxes](disclosure-checkboxes.md) — which boxes to check
- [Issue Review Guidelines](issue-review-guidelines.md) — how your issue will be evaluated
- [Merge Request Workflow](merge-request-workflow.md) — next step after issue creation
