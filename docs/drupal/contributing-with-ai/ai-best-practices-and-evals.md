...
When the MVP ships, it becomes the primary reference for AI-assisted Drupal contribution quality. Until then, the adopted policy (see [Drupal AI Policy](drupal-ai-policy.md)) is the enforced rule.
...
- `ai_best_practices` releases — when the MVP ships, update [Drupal AI Policy](drupal-ai-policy.md) and this guide to point to it
...
- Reference: [ai_best_practices project](https://www.drupal.org/project/ai_best_practices)
- Reference: [webchick Eval Commons article](https://webchick.tech/toward-a-shared-eval-infrastructure-for-drupal-ai-a-proof-of-concept)
- Reference: [Every Eval Ever](https://evalevalai.com/projects/every-eval-ever/)
