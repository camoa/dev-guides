...
| Set up PHPUnit configuration | [Testing Infrastructure Setup](testing-infrastructure-setup.md) | Use this guide when setting up a new module for testing or configuring CI/CD pipelines for automated test execution. |
