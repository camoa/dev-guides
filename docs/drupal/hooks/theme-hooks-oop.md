...
| 11.2 or earlier as well | `.theme` file, procedural, with a `#[LegacyHook]` shim only if you also ship the class | The theme collector landed in 11.3.0; older cores never see `src/Hook/` in a theme |
