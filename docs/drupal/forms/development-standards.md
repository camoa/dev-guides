...
**Purpose:** Critical mistakes to avoid when implementing forms. Each anti-pattern includes WHY it's wrong and what breaks when you do it.
...
- [Security Best Practices](security-best-practices.md) (next section)
- [Performance Optimization](performance-optimization.md)
- [Form Alter System](form-alter-system.md)
- [Configuration API Guide](../config-management/index.md)
- [Testing Forms Guide](../testing/index.md)
