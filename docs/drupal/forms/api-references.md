...
## Reference: Official Drupal Documentation
...
## Reference: Core Code References
...
## Reference: Contributed Module Examples
...
## Reference: API Documentation Sites
...
- [Configuration API Guide](../config-management/index.md) (for config management)
- [AJAX API Guide](../ajax/index.md) (for advanced AJAX)
