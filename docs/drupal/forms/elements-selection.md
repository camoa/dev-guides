...
## Reference: File Upload Elements
...
- File API Guide
- [Security: File Upload Guide](security-best-practices.md)
- [Media vs File Decision Guide](../media/index.md)
- [Grouping and Action Elements](elements-grouping.md)
