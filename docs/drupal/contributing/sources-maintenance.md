---
description: "Source references and maintenance manifest for the contributing guides — web sources, code sources, and version history"
---
...
|---|---|---|
| `research_standards_gitlab_workflow.md` | drupalci-pipeline-gitlab-templates, reproducing-drupalci-failures-locally, drupal-coding-standards-ci-parity, issue-forks-merge-requests, three-contribution-workflows-compared | 2026-05-20/21 |
| `research_environment_scaffold.md` | ddev-contribution-environment, contrib-project-scaffolding, three-contribution-workflows-compared | 2026-05-21 |
| `research_contribution_best_practices.md` | drupal-issue-lifecycle, contribution-etiquette-rtbc-credit, three-contribution-workflows-compared, module-theme-maintainer | 2026-05-20 |
| `research_phpunit_tooling_gaps.md` | contrib-project-scaffolding, issue-forks-merge-requests (drupalorg-cli) | 2026-05-20 |
| `architecture.md` | three-contribution-workflows-compared (boundary section), module-theme-maintainer (AI review) | 2026-05-21 |
| `dev-guides-manifest.md` | All sections (scope + citation mapping) | 2026-05-21 |
