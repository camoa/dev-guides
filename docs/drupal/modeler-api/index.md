...
| Understand how routes and permissions are auto-generated | [Routes and Permissions](routes-permissions.md) | Routes and permissions are generated dynamically at container rebuild; you write no route YAML. configEntityBasePath() must return a non-NULL string for CRUD routes to be generated. Use ModelerApiPermissions::getPermissionKey() to build permission strings programmatically — never hardcode them. |
