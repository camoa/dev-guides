...
| I need to... | Guide |
|--------------|-------|
| Understand what JSON:API is and when to use it | [What is JSON:API](what-is-jsonapi.md) |
| Decide between JSON:API vs REST vs GraphQL | [JSON:API vs REST vs GraphQL](jsonapi-vs-rest-vs-graphql.md) |
| Understand the core architecture and components | [Core Architecture](core-architecture.md) |

### Work with Resources

| I need to... | Guide |
|--------------|-------|
| Understand URL structure and resource types | [URL Structure & Resource Types](url-structure-resource-types.md) |
| Fetch data with GET requests | [Fetching Resources (GET)](fetching-resources.md) |
| Filter results by field values, operators, or groups | [Filtering](filtering.md) |
| Include related resources and limit response fields | [Includes & Sparse Fieldsets](includes-sparse-fieldsets.md) |
| Sort results and paginate collections | [Sorting & Pagination](sorting-pagination.md) |
