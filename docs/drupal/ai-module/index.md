...
| Translate content with AI | [AI Translate](ai-translate.md) | **Status: STANDALONE** — `drupal/ai_translate` 1.3.1. Requires `drupal/ai >1.2.1` + `content_translation`; one-click AI content/interface translation with per-site and per-language prompt customization via config entities. |
