...
4. **Verify permissions**
   ...
   - "Configure editable {bundle} {entity_type} layout overrides" — per-entity layouts
   ...
   **Editor-enablement permission set:** to hand LB to a non-admin editor role, grant three permissions:
   ...
   - `configure editable <bundle> <entity_type> layout overrides` — dynamic per-bundle permission generated by `layout_builder.permissions.yml` `permission_callbacks`
