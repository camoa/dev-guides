...
| Map brand colors to DaisyUI theme | [Brand Color Mapping Workflow](brand-color-mapping-workflow.md) | Use this when you receive brand guidelines (hex colors, Pantone, etc.) and need to map them to DaisyUI's semantic color system. |
