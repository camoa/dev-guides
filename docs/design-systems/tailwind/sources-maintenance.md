---
description: "Source references and maintenance manifest for the tailwind guides — web sources, code sources, and version history"
---

# Sources & Maintenance

## Drupal Research Install
Path: N/A — this guide is framework-agnostic (not Drupal-specific)

## Web Sources

| Source | URL | Guide Sections | Last Verified |
|---|---|---|---|
| Tailwind CSS v4.0 Release Blog | https://tailwindcss.com/blog/tailwindcss-v4 | 1, 1 (v3 vs v4 table) | 2026-02-19 |
| Tailwind Installation Docs | https://tailwindcss.com/docs/installation | 2 | 2026-02-19 |
| Tailwind PostCSS Installation | https://tailwindcss.com/docs/installation/using-postcss | 2 | 2026-02-19 |
| Tailwind Next.js Guide | https://tailwindcss.com/docs/guides/nextjs | 2 | 2026-02-19 |
...
| Package | Path | Guide Sections | Version |
|---------|------|----------------|---------|
| tailwindcss | `node_modules/tailwindcss/` | 1, 2, 3, 6, 7, 8, 12 | 4.2.0 |
| tailwindcss theme | `node_modules/tailwindcss/theme.css` | 3, 5, 6, 7, 8 | 4.2.0 |
| tailwindcss index | `node_modules/tailwindcss/index.css` | 3, 6 | 4.2.0 |
| tailwindcss utilities | `node_modules/tailwindcss/utilities.css` | 3 | 4.2.0 |
| tailwindcss preflight | `node_modules/tailwindcss/preflight.css` | 3 | 4.2.0 |
| @tailwindcss/postcss | `node_modules/@tailwindcss/postcss/` | 2 | 4.2.0 |
| class-variance-authority | `node_modules/class-variance-authority/` | 10.2 | 0.7.1 |
| class-variance-authority source | `node_modules/class-variance-authority/dist/index.js` | 10.2 | 0.7.1 |
| clsx | `node_modules/clsx/` | 10.2, 10.3 | 2.1.1 |
| clsx source | `node_modules/clsx/dist/clsx.js` | 10.3 | 2.1.1 |
| tailwind-merge | `node_modules/tailwind-merge/` | 10.3 | 3.5.0 |
| tailwind-merge source | `node_modules/tailwind-merge/src/` | 10.3 | 3.5.0 |
| Next.js app globals | `src/app/globals.css` | 3 | Next.js 16.1.6 |
| Next.js app layout | `src/app/layout.tsx` | 3 | Next.js 16.1.6 |
| Next.js postcss config | `postcss.config.mjs` | 2 | Next.js 16.1.6 |
