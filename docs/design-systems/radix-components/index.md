...
|-------------|-------|---------|
| Understand Radix SDC architecture | [Radix Component Architecture](radix-component-architecture.md) | Understanding Radix's SDC architecture for component selection and customization decisions. |
| Decide component vs override vs custom | [Component Selection Strategy](component-selection-strategy.md) | Deciding whether to use base component, override, or create custom. |
| Modify Radix component for sub-theme | [Component Override Patterns](component-override-patterns.md) | Modifying Radix base component for sub-theme. |
| Build project-specific custom component | [Creating Custom Components](creating-custom-components.md) | Building project-specific UI not in Radix/Bootstrap. |
| Use accordions, cards, carousels, modals, tables | [Layout Components](layout-components.md) | Components for organizing and containing content in structured layouts. These components help create interactive, collapsible, and organized content presentations including accordions, cards, carousels, modals, and data tables. |
| Build breadcrumbs, navbars, pagination, tabs | [Navigation Components](navigation-components.md) | Components for site navigation, wayfinding, and menu systems. Use these for breadcrumbs, tabs, navigation menus, navbars, and pagination across multiple pages. |
