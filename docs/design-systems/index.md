---
description: Design system guides — recognition, Bootstrap mapping, Radix SDC implementation, Radix component reference, web design strategy
---

# Design Systems

Guides for the design-to-code pipeline: analyze a design system, map it to Bootstrap, implement in Radix/SDC.
...
| Choose a design style, pick components, build accessible pages | [Visual Design Strategy](visual-design-strategy/index.md) |
