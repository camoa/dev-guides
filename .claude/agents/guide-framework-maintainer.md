...
**Handling outdated patterns**: When a pattern becomes deprecated, **update or delete the section** — don't keep parallel "old vs new" versions. Version-specific guidance belongs in the `drupal_version:` field; historical context belongs in git history.
